...
/**
 * Class that solves a TSP problem by neighbourhood search and 2-opt moves
 */
class TSPSolver
{
public:
   ...
   */
  static double evaluate (const TSPSolution& sol, const TSP& tsp){   //FIXED: added 'static' because it sounds reasonable
    double total = 0.0;
